...
import static com.bytedance.androidcamp.network.dou.api.IMiniDouyinService.BASE_URL;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> call =
                miniDouyinService.postVideo("3170105468","武靖超",coverImagePart,videoPart);
    ...
    public void fetchFeed(View view) {
        ...
        call.enqueue(new Callback<GetVideosResponse>() {
            ...
            @Override
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse>
                    response) {
